...
public class FrameSYLTTest  {
	...
	public static void main (String [] args) throws Exception{
		...
		FrameSYLTTest frameSYLTTest = new FrameSYLTTest();
		frameSYLTTest.testWriteFrame();
	}
	
	public void testWriteFrame() throws Exception {
		File testFile = new File("C:\\Users\\Alex\\Desktop\\04 Wasting My Young Years.mp3");
		...
		// Create USLT frame
		FrameBodySYLT frameBody = new FrameBodySYLT(TEXT_ENCODING_KEY, LANG_CODE, TIMESTAMP_FORMAT_KEY,
				CONTENT_TYPE_KEY, DESCRIPTION, data);
		...
		System.out.println(frameBody.getDescription());
		System.out.println(frameBody.getLanguage());
		System.out.println(frameBody.getTextEncoding());
		System.out.println(frameBody.getTimeStampFormat());
		System.out.println(frameBody.getContentType());
		System.out.println("Lyrics:"+ frameBody.getLyrics().toString());
